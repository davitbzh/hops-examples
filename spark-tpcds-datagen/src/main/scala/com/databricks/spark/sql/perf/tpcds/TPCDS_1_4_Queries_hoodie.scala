...
trait TPCDS_1_4_Queries_hoodie extends Benchmark {
  ...
  val tpcds1_4Queries = Seq(
    ("q1", s"""
             ...
             |    AND  _hoodie_commit_time=$timeStamp
    ...
    ("q2", s"""
             ...
             |  WHERE _hoodie_commit_time=$timeStamp AND date_dim.d_week_seq = wswscs.d_week_seq AND d_year = 2001) y,
             ...
             |  FROM wswscs, date_dim
             | WHERE _hoodie_commit_time=$timeStamp AND  date_dim.d_week_seq = wswscs.d_week_seq AND d_year = 2001 + 1) z
    ...
    ("q8", s"""
             ...
             |          WHERE _hoodie_commit_time=$timeStamp AND substr(ca_zip,1,5) IN (
    ...
    ("q9", s"""
              ...
              |from reason
              |where r_reason_sk = 1 AND _hoodie_commit_time=$timeStamp
            """.stripMargin),
    ("q10", s"""
              | select
              ...
              |  AND _hoodie_commit_time=$timeStamp AND
    ...
    ("q12", s"""
              ...
              | where
              | _hoodie_commit_time=$timeStamp AND
    ...
    ("q13", s"""
              ...
              |     ,customer_address
              |     ,date_dim
              | where _hoodie_commit_time=$timeStamp AND s_store_sk = ss_store_sk
    ...
    ("q14a", s"""
               ...
               |       AND _hoodie_commit_time=$timeStamp ) x
